...
run_bootstrap_second_stage() {
	...
	output="$(ln -s "termux-bootstrap-second-stage.sh" \
		"/data/data/com.termux/files/usr/etc/termux/termux-bootstrap/second-stage/termux-bootstrap-second-stage.sh.lock" 2>&1)"
	return_value=$?
...
then delete the '/data/data/com.termux/files/usr/etc/termux/termux-bootstrap/second-stage/termux-bootstrap-second-stage.sh.lock' \
...
'/data/data/com.termux/files/usr/etc/termux/termux-bootstrap/second-stage/termux-bootstrap-second-stage.sh.lock'"
